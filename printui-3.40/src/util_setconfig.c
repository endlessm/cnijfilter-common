...
static void SetDefaultSetConfigType001_AutoPower( GtkWidget *dialog, short onIndex, short offIndex  )
{
	...
	SetComboBoxItems(powerOnCombo, (char **)setconfig_type001_02_onlist, onSize, onIndex);		
	SetComboBoxItems(powerOffCombo, (char **)setconfig_type001_02_offlist, offSize , offIndex);
                                        ...
                                        gpointer         user_data)
{
	...
	if ( gUiType == UI_CUSTOMSETTINGS_TYPE001 ){
		SetDefaultSetConfigType001_CustomSettings( (GtkWidget *)button, 0, 0, CUSTOM_SETTINGS_TYPE001_RADIOBUTTON_DEFAULT );
	}	
