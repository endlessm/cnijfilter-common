...
gchar *s = N_("Fine Art Letter 8.5\"x11\" 215.9x279.4mm");
/* size_a4_fine_art */
...
/* LUM_IDD_GENERAL_RAD_2_IDOK */
gchar *s = N_("Send");
/* LUM_IDS_MNTMSG_PHA_START2_3P_PAPERSRC */
gchar *s = N_("Starting print head alignment.\n"
              "\n"
              "Since the alignment involves printing, get the printer ready (connect the cable and turn the power on) and \n"
              ...
              "\n"
              "To print and check the current setting, click Print Alignment Value.");
/* LUM_IDS_MNTMSG_PATTERNCHECKPRE_PAPERSRC_07 */
gchar *s = N_("Prints a pattern that lets you check whether the print head nozzles are clogged.\n"
              "\n"
              "Get the printer ready (connect the cable and turn the power on), load a sheet of A4 or letter size, \n"
              "plain paper into the paper source for plain paper, and click the Print Check Pattern.");
