...
short SetExtMargin(LPBJF_POS_PRNINFO, LPBJF_POSINFO, LPBJF_MARGIN_INFO);
short SetBbox( LPBJF_POS_IMGINFO, long *, LPBJF_POSINFO,LPBJF_MARGIN_INFO  );
