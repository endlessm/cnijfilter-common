...
#define INTERNAL_VERSION_STR	"3.70.01.022"

#define PRINTUI_VERSION_VER_STR		"3.70"
#define PRINTUI_VERSION_COMMAND_STR	" (printui)"
#define PRINTUI_VERSION_FROM_STR	"2001"
#define PRINTUI_VERSION_TO_STR		"2012"
