...
PRIVATE guint		gCartridgeWidth[CARTRIGE_TYPE_NUM] = {108, 57, 0, 74, 82, 40, 40, 108};
...
/*** Parameters end ***/
	...
	else if ((pCartridgeClass->type == ID_CARTRIDGE_TYPE_PHOTO || pCartridgeClass->type == ID_CARTRIDGE_TYPE_PHOTO2)
