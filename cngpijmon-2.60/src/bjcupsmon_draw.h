...
#define CARTRIGE_TYPE_NUM	18		// add ip2200(BK,CL,BKH,CLH), ip4200, ip6600D, ip7500

// Num of cartridge class.
#define CARTRIGE_CLASS_NUM	38		// add ip2200(BK*2,CL*2,BKH*2,CLH*2), ip4200*2, ip6600D*2, ip7500*2
