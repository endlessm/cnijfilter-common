...
typedef enum {
	...
	ID_STS_MESSAGE_OC_PAPER_OUT23,				// Paper out. (Operator call)	v2.5
	ID_STS_MESSAGE_OC_PAPER_OUT24,				// Paper out. (Operator call)	v2.5
	ID_STS_MESSAGE_OC_PAPER_OUT3,				// Paper out. (Operator call)	v2.5
	ID_STS_MESSAGE_OC_PAPER_OUT33,				// Paper out. (Operator call)	v2.5
	...
	ID_STS_MESSAGE_OC_INKOUT_RED,				// Red ink out. (Operator Call)
	ID_STS_MESSAGE_OC_INKOUT_GREEN,				// Green ink out. (Operator Call)
	ID_STS_MESSAGE_OC_INKOUT_BLACK3e,			// Black [3e] ink out. (Operator Call)
	...
	ID_STS_MESSAGE_BUSY_CARTRIDGE_CHANGE2,		// Cartridge replacement. (Busy status) v2.5
	ID_STS_MESSAGE_BUSY_CARTRIDGE_CHANGE3,		// Cartridge replacement. (Busy status) v2.5
	...
	ID_STS_MESSAGE_WAR_INKLOW_40_PRE,			// ink low level 3 pre message. (Warning)
	ID_STS_MESSAGE_WAR_INKLOW_BLACK40,			// black ink low level 3. (Warning)
	ID_STS_MESSAGE_WAR_INKLOW_BLACK50,			// black ink low level 3. (Warning)
	ID_STS_MESSAGE_WAR_INKLOW_COLOR41,			// color ink low level 3. (Warning)
	ID_STS_MESSAGE_WAR_INKLOW_COLOR51,			// color ink low level 3. (Warning)
	...
	ID_STS_MESSAGE_OC_INKTANK_NONE,				// Ink tank nothing. i250/i255
	...
	ID_STS_MESSAGE_OC_INKOUT_TANK_2nd,			// Ink Out error (ink tank) 2nd messeage.
