...
char *s = N_("Adjustment in Column F (-3 to +3)");
/* LUM_IDS_MNTMSG_PHA_CPT_G_33 */
char *s = N_("Adjustment in Column G (-3 to +3)");
/* LUM_IDS_MNTMSG_PHA_CPT_Q_44 */
char *s = N_("Adjustment in Column Q (-4 to +4)");
...
char *s = N_("Adjustment in Columns F and G (-3 to +3)");
...
char *s = N_("Adjustment in Columns M to Q (-5 to +5)");
/* LUM_IDS_MNTMSG_PHA_CPT_O_T_22 */
char *s = N_("Adjustment in Columns O to T (-2 to +2)");
...
char *s = N_("Cancel");
char *s = N_("Canon Inkjet Printer Driver Ver.3.20 for Linux (UI)\n"
...
char *s = N_("Examine the printed patterns, and enter the pattern number \n"
...
char *s = N_("Examine the printed patterns, and enter the pattern number of \n"
...
char *s = N_("Examine the printed patterns, and fill in the fields for columns \n"
...
char *s = N_("Examine the printed patterns, and fill in the fields for columns W \n"
...
char *s = N_("Execute print head alignment. Examine the printed patterns, \n"
...
char *s = N_("Starting bottom plate cleaning to prevent paper smudges during printing.\n"
             "\n"
             "This operation requires a sheet of A4 or letter size, plain paper. Follow these directions to execute bottom plate cleaning.");
