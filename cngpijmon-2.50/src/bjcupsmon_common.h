...
#define CARTRIDGE_COLOR_TYPE_NUM	13	// Number of all color type +2(V2.4 rl) +1(v2.5)
...
typedef enum {
	...
	ID_STS_MESSAGE_OC_PAPER_JAM1,				// Paper jam. (Operator call)	v2.5
	ID_STS_MESSAGE_OC_PAPER_JAM03,				// Paper jam. (Operator call)	v2.5
	ID_STS_MESSAGE_OC_PAPER_JAM04,				// Paper jam. (Operator call)	v2.5
