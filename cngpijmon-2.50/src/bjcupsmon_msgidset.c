...
ST_MSGTBL inkout[]={
  ...
  {'L', ID_STS_MESSAGE_OC_INKOUT_BLACK3e},
  {'l', ID_STS_MESSAGE_OC_INKOUT_BLACK},	// 860i [6]
...
ST_MSGTBL inklowpart1[]={
  ...
  {'L', ID_STS_MESSAGE_WAR_INKLOW_BLACK3e},	// 860i [3e]
  {'B', ID_STS_MESSAGE_WAR_INKLOW_BLACK24},	// S300
  {'l', ID_STS_MESSAGE_WAR_INKLOW_BLACK},	// 860i [6]
...
int chk_operatorcall_level1(ST_CUPSSTS *p_tbl, ST_PrinterStatus *p_sts)
{
  ...
  else if (*(p_sts->pMessageID) == ID_STS_MESSAGE_OC_PAPER_OUT21 || *(p_sts->pMessageID) == ID_STS_MESSAGE_OC_PAPER_OUT22)	// v.2.5
  {
