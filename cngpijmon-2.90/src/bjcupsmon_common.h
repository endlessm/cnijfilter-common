...
typedef enum {
	...
	ID_STS_MESSAGE_WAR_INKLOW_BLACK19,			// Black [19] ink low. (Warning)
	ID_STS_MESSAGE_WAR_INKLOW_COLOR19,			// Color [19] ink low. (Warning)
	ID_STS_MESSAGE_WAR_INKLOW_BLACK35,			// Black [35] ink low. (Warning)
	ID_STS_MESSAGE_WAR_INKLOW_COLOR36,			// Color [36] ink low. (Warning)
	...
	ID_STS_MESSAGE_OC_BLACK19,					// Black [19] ink error. (Operator call)
	ID_STS_MESSAGE_OC_COLOR19,					// Color [19] ink error. (Operator call)
	ID_STS_MESSAGE_OC_BLACK35,					// Black [35] ink error. (Operator call)
	ID_STS_MESSAGE_OC_COLOR36,					// Color [36] ink error. (Operator call)
