...
#define CARTRIGE_TYPE_NUM	24		// add ip3300 and iPxxxx and Mini*2 and iP90*2

// Num of cartridge class.
#define CARTRIGE_CLASS_NUM	50		// add (ip3300 + iPxxxx + Mini*2+ ip90*2) *2

// Num of cartridge pixmap.
#define CARTRIDGE_PIXMAP_NUM	19	// +2(Red+SenryoB)+1(Green)+Color(iPxxxx)+Color/Black(iP90)
...
PRIVATE void drawIconPixmap(GtkWidget *, ST_CartridgeClass *, ENUM_CartridgePixmapID, ENUM_InkStatusID, ENUM_STSMessageID *, gint, guint , guint );
