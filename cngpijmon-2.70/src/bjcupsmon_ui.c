...
PRIVATE const gchar	*gSTSMessageTable[] = {		// Printer status message table.
	...
	N_("The holder is in the replacement position.\nAfter replacing the print head or the ink tank, close the cover of the printer. To replace only the ink tanks, do not remove the print head from the printer. Do not touch the lock lever.\n"),
	N_("The holder is in the replacement position.\nAfter replacing the print head or the ink tank, close the cover of the printer. To replace only the ink tanks, do not remove the print head from the printer. Do not touch the lock lever.\n"),
	N_("Printing.\n"),
...
PRIVATE const gchar	*gOtherMessageTable[] = {		// Other message table.
	...
	"  cngpijmon(2.00.01.016) : argument error.\n  Usage: cngpijmon****** [cups entry name]\n\n   ex) cngpijmonip3300 IP3300\n\n",
};
