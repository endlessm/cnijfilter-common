...
/* model_MX720 */
gchar *s = N_("MX720 series");
/* model_MX920 */
gchar *s = N_("MX920 series");
/* model_MX390 */
gchar *s = N_("MX390 series");
/* model_MX450 */
gchar *s = N_("MX450 series");
/* model_MX520 */
gchar *s = N_("MX520 series");
/* model_E610 */
gchar *s = N_("E610 series");
/* print_color_message */
gchar *s = N_("Color");
/* supply_asf_reartray */
...
/* LUM_IDS_CLEAN_PS_EX2 */
gchar *s = N_("Cleaning consumes ink.\n"
              "Do not close the paper output tray until the cleaning is complete.");
/* LUM_IDS_CLEAN_PS_DEEP_EX2 */
gchar *s = N_("Deep cleaning consumes much more ink than regular cleaning. \n"
...
/* LUM_IDS_MNTMSG_PHA_GUIDE_FROD_2 */
gchar *s = N_("Executing print head alignment corrects the misalignment of colors and lines. \n"
