...
PRIVATE const gchar	*gSTSMessageTable[] = {		// Printer status message table.
	...
	N_("A digital camera or device that is not supported by the direct printing function is connected to the Direct Print Port. Disconnect the cable from the Camera Port, and press the RESUME button.\n"),	// 560i 860i 990i
