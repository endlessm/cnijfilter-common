...
GLOBAL const gchar* g_printing_type_cups_name[] =
{
	"printing_type_normal",
	"printing_type_scale",
	NULL
...
GLOBAL const short g_printing_type_cups_value[] =
{
	PRINTING_TYPE_NORMAL,	// Normal.
	PRINTING_TYPE_SCALE,	// Scaling.
	0
...
GLOBAL GList* g_paper_size_list;
GLOBAL GList* g_paper_size_margin_list;
GLOBAL short g_paper_size_value;

GLOBAL short g_duplex_value;
...
GLOBAL UIPageSizeDialog* g_pagesize_dialog;
