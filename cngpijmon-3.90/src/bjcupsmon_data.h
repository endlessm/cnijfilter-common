...
ST_INKTYPE_TBL ink_type_tbl[]={
  ...
  {"E610",    cartridge_type3_region_tbl},
  {"MX390",   cartridge_type3_region_tbl},
  {"MX450",   cartridge_type3_region_tbl},
  {"MX520",   cartridge_type3_region_tbl},
  {"MX720",  ink_type3_region_tbl},
  {"MX920",  ink_type3_region_tbl},
  {ENDTAG, 0}
};
...
/* mx920/mx720 */
/* Ver.3.90 for mx920 dbs string pattern table */
static const
ST_MSGTBL mx920_dbs_string_pattern_table[]={
  {'L', DBS_CLEANING_PATTERN01},		/* A-05 */
  {'T', DBS_TEST_PRINTING_PATTERN01},	/* A-04 */
  {'I', DBS_PRINTER_USED_PATTERN01},	/* E-10 */
  {'B', DBS_PRINTER_PATTERN01},			/* A-09 */
...
/* Ver.3.90 for mx920 djs string pattern table */
static const
ST_MSGTBL mx920_djs_string_pattern_table[]={
  {'P', DJS_BASE_PRINTING_PATTERN01},		/* A-04 */
  {'L', DJS_BASE_PRINTING_PATTERN01},		/* A-04 */
  {'F', DJS_BASE_PRINTING_PATTERN01},		/* A-04 */
  {'I', DJS_BASE_ONLINE_PATTERN01},			/* A-03 */
...
/* Ver.3.90 for mx920 doc string pattern table */
static const
ST_MSGTBL mx920_doc_string_pattern_table[]={
  /* operator level1 */
  {'Z',	OC2700_PANELCHK_PATTERN01},
  {'U',	OC2001_USBDEVICE_PATTERN03},
  {'p',	OC1007_PAPEROUT_PATTERN02},
  {'Q',	OC1008_PAPEROUT_PATTERN02},
  {'q',	OC1300_PAPERJAM_PATTERN08},
  {'n',	OC1303_PAPERJAM_PATTERN04},
  {'i',	OC1304_PAPERJAM_PATTERN12},
  {'j',	OC1311_PAPERJAM_PATTERN04},
  {'J',	OC1312_PAPERJAM_PATTERN04},
  {'H',	OC1401_CARTRIDGENONE_PATTERN04},
  {'r',	OC1403_CARTRIDGENONE_PATTERN01},
  {'L',	OC4101_USERSIZE_PATTERN02},
  /* operator level2 */
  {'x', OC1700_USEDTANK_ALMOST_PATTERN04},
  ...
  {'K', OC1856_CDR_GUIDE_PATTERN04},
  {'I', OC1858_CDR_GUIDE_PATTERN02},
  {'O', DBS_HEADPROTECT_PATTERN03}, 	 /* DOC:1200 && DWS:1900 A-35 */
  {ENDTAG, 	0}
};

/* Ver.3.90 for mx920 dsc string pattern table */
static const
ST_MSGTBL mx920_dsc_string_pattern_table[]={
  {'I', SC5B00_USEDTANK_FULL_PATTERN02},
  {'J', SC5B01_USEDTANK_FULL_PATTERN02},
  {'C', SC5101_CARRIAGEPOSITION_PATTERN01},
  {'R', SC5100_CR_POSITIONEROOR_PATTERN01},
  {'V', SCB200_VH_MONITOR_EROOR_PATTERN01},
  {'P', SC6001_PGUNIT_EROOR_PATTERN01},
  {'M', SCOTHER_COMMON_SERIVICE_ERROR_PATTERN02},
  {ENDTAG, 0}
};

/* Ver.3.90 for mx920 dws string pattern table */
static const
ST_MSGTBL mx920_dws_string_pattern_table[]={
  {'T', WR1500_DWS_INKLOW_PATTERN01},			/* D-01 */
  {'F', WR1570_DWS_INKOUT_PATTERN02},			/* B-4R */
  {'Z', WR1600_DWS_INKSTATUS_OFF_PATTERN01},	/* B-36R */
  {ENDTAG, 0}
...
/* Ver.3.90 for mx920 doc pict area pattern table */
static const
ST_MSGTBL mx920_doc_pict_disable_pattern_table[]={
  {'H', 1},		/* B-01 */
  {ENDTAG, 0}
};


/* Ver.3.90 for mx920 dbs pict area pattern table */
static const
ST_MSGTBL mx920_dbs_pict_disable_pattern_table[]={
  {'I', 1},		/* E-10 */
  {ENDTAG, 0}
};

/* Ver.3.90 for mx920 doc unknownicon draw pattern table */
static const
ST_MSGTBL mx920_doc_unknownicon_draw_pattern_table[]={
  {'f', 1},		/* B-36 */
  {ENDTAG, 0}
};

/* Ver.3.90 for mx920 doc icon delete pattern table */
static const
ST_MSGTBL mx920_doc_icon_delete_pattern_table[]={
  {'s', 1},		/* B-31 */
  {'e', 1},		/* B-32 */
  {'S', 1},		/* B-35 */
  {'t', 1},		/* B-40 */
...
/* mx520 */
/* Ver.3.90 for mx520 dbs string pattern table */
static const
ST_MSGTBL mx520_dbs_string_pattern_table[]={
  {'L', DBS_CLEANING_PATTERN01},		/* A-05 */
//  {'D', DBS_CARTRIDGE_CHANGE_PATTERN01},/* A-06 */
  {'T', DBS_TEST_PRINTING_PATTERN01},	/* A-04 */
  {'I', DBS_PRINTER_USED_PATTERN01},	/* E-10 */
...
/* Ver.3.90 for mx520 djs string pattern table */
static const
ST_MSGTBL mx520_djs_string_pattern_table[]={
  {'P', DJS_BASE_PRINTING_PATTERN01},	/* A-04 */
  {'L', DJS_BASE_PRINTING_PATTERN01},	/* A-04 */
  {'F', DJS_BASE_PRINTING_PATTERN01},	/* A-04 */
  {'I', DJS_BASE_ONLINE_PATTERN01},		/* A-03 */
...
/* Ver.3.90 for mx520 doc string pattern table */
static const
ST_MSGTBL mx520_doc_string_pattern_table[]={
  /* operator level1 */
  {'Z',	OC2700_PANELCHK_PATTERN01},
  {'U',	OC2001_USBDEVICE_PATTERN03},
  {'p',	OC1003_PAPEROUT_PATTERN10},
  {'q',	OC1300_PAPERJAM_PATTERN09},
  {'n',	OC1303_PAPERJAM_PATTERN13},
  {'i',	OC1304_PAPERJAM_PATTERN13},
  {'H',	OC1401_CARTRIDGENONE_PATTERN03},
  {'h',	OC1485_CARTRIDGENONE_PATTERN01},
  {'r',	OC1403_CARTRIDGENONE_PATTERN01},
  {'c',	OC2700_PANELCHK_PATTERN01}, /* change Ver.3.90 */
  /* operator level2 */
  {'x', OC1700_USEDTANK_ALMOST_PATTERN04},
  {'k', OC1701_USEDTANK_ALMOST_PATTERN04},
  {'R', OC1310_DUPLEX_STOPPAGE_PATTERN04},
...
/* Ver.3.90 for mx520 dsc string pattern table */
static const
ST_MSGTBL mx520_dsc_string_pattern_table[]={
  {'I', SC5B00_USEDTANK_FULL_PATTERN02},
  {'J', SC5B01_USEDTANK_FULL_PATTERN02},
  {'R', SC5100_CR_POSITIONEROOR_PATTERN02},
  {'M', SCOTHER_COMMON_SERIVICE_ERROR_PATTERN02},
...
/* Ver.3.90 for mx520 dws string pattern table */
static const
ST_MSGTBL mx520_dws_string_pattern_table[]={
  {'T', WR1500_DWS_INKLOW_PATTERN02},			/* D-01 */
  {'t', WR1500_DWS_INKLOW_PATTERN02},			/* D-01 */
  {'Z', WR1600_DWS_INKSTATUS_OFF_PATTERN01},	/* B-4R */
  {ENDTAG, 	0}
...
/* Ver.3.90 for mx520 doc pict area pattern table */
static const
ST_MSGTBL mx520_doc_pict_disable_pattern_table[]={
  //{'H', 1},		/* B-01 */
  {ENDTAG, 0}
};

/* Ver.3.90 for mx520 dbs pict area pattern table */
static const
ST_MSGTBL mx520_dbs_pict_disable_pattern_table[]={
  {'I', 1},		/* E-10 */
  {ENDTAG, 0}
};

/* Ver.3.90 for mx520 doc unknownicon draw pattern table */
static const
ST_MSGTBL mx520_doc_unknownicon_draw_pattern_table[]={
  {'w', 1},		/* B-36 */
  {ENDTAG, 0}
};

/* Ver.3.90 for mx520 doc icon delete pattern table */
static const
ST_MSGTBL mx520_doc_icon_delete_pattern_table[]={
  {'T', 1},		/* B-21 */
  {ENDTAG, 0}
};
...
ST_MODEL_PATTERN_TBL dbs_model_pattern_table[]={
  ...
  {"E610",		mx520_dbs_string_pattern_table	},
  {"MX390",		mx520_dbs_string_pattern_table	},
  {"MX450",		mx520_dbs_string_pattern_table	},
  {"MX520",		mx520_dbs_string_pattern_table	},
  {"MX720",		mx920_dbs_string_pattern_table	},
  {"MX920",		mx920_dbs_string_pattern_table	},
  {ENDTAG, 		0}
};
...
ST_MODEL_PATTERN_TBL djs_model_pattern_table[]={
  ...
  {"E610",		mx520_djs_string_pattern_table	},
  {"MX390",		mx520_djs_string_pattern_table	},
  {"MX450",		mx520_djs_string_pattern_table	},
  {"MX520",		mx520_djs_string_pattern_table	},
  {"MX720",		mx920_djs_string_pattern_table	},
  {"MX920",		mx920_djs_string_pattern_table	},
  {ENDTAG, 		0}
};
...
ST_MODEL_PATTERN_TBL doc_model_pattern_table[]={
  ...
  {"E610",		mx520_doc_string_pattern_table	},
  {"MX390",		mx520_doc_string_pattern_table	},
  {"MX450",		mx520_doc_string_pattern_table	},
  {"MX520",		mx520_doc_string_pattern_table	},
  {"MX720",		mx920_doc_string_pattern_table	},
  {"MX920",		mx920_doc_string_pattern_table	},
  {ENDTAG, 		0}
};
...
ST_MODEL_PATTERN_TBL dsc_model_pattern_table[]={
  ...
  {"E610",		mx520_dsc_string_pattern_table	},
  {"MX390",		mx520_dsc_string_pattern_table	},
  {"MX450",		mx520_dsc_string_pattern_table	},
  {"MX520",		mx520_dsc_string_pattern_table	},
  {"MX720",		mx920_dsc_string_pattern_table	},
  {"MX920",		mx920_dsc_string_pattern_table	},
  {ENDTAG, 		0}
};
...
ST_MODEL_PATTERN_TBL dws_model_pattern_table[]={
  ...
  {"E610",		mx520_dws_string_pattern_table	},
  {"MX390",		mx520_dws_string_pattern_table	},
  {"MX450",		mx520_dws_string_pattern_table	},
  {"MX520",		mx520_dws_string_pattern_table	},
  {"MX720",		mx920_dws_string_pattern_table	},
  {"MX920",		mx920_dws_string_pattern_table	},
  {ENDTAG, 		0}
};
...
ST_MODEL_PATTERN_TBL doc_pict_disable_pattern_table[]={
  ...
  {"E610",		mx520_doc_pict_disable_pattern_table	},
  {"MX390",		mx520_doc_pict_disable_pattern_table	},
  {"MX450",		mx520_doc_pict_disable_pattern_table	},
  {"MX520",		mx520_doc_pict_disable_pattern_table	},
  {"MX720",		mx920_doc_pict_disable_pattern_table	},
  {"MX920",		mx920_doc_pict_disable_pattern_table	},
  {ENDTAG, 		0}
};
...
ST_MODEL_PATTERN_TBL dbs_pict_disable_pattern_table[]={
  ...
  {"E610",		mx520_dbs_pict_disable_pattern_table	},
  {"MX390",		mx520_dbs_pict_disable_pattern_table	},
  {"MX450",		mx520_dbs_pict_disable_pattern_table	},
  {"MX520",		mx520_dbs_pict_disable_pattern_table	},
  {"MX720",		mx920_dbs_pict_disable_pattern_table	},
  {"MX920",		mx920_dbs_pict_disable_pattern_table	},
  {ENDTAG, 		0}
};
...
ST_MODEL_PATTERN_TBL doc_unknownicon_draw_pattern_table[]={
  ...
  {"E610",		mx520_doc_unknownicon_draw_pattern_table	},
  {"MX390",		mx520_doc_unknownicon_draw_pattern_table	},
  {"MX450",		mx520_doc_unknownicon_draw_pattern_table	},
  {"MX520",		mx520_doc_unknownicon_draw_pattern_table	},
  {"MX720",		mx920_doc_unknownicon_draw_pattern_table	},
  {"MX920",		mx920_doc_unknownicon_draw_pattern_table	},
  {ENDTAG, 		0}
};
...
ST_MODEL_PATTERN_TBL doc_icon_delete_pattern_table[]={
  ...
  {"E610",		mx520_doc_icon_delete_pattern_table		},
  {"MX390",		mx520_doc_icon_delete_pattern_table		},
  {"MX450",		mx520_doc_icon_delete_pattern_table		},
  {"MX520",		mx520_doc_icon_delete_pattern_table		},
  {"MX720",		mx920_doc_icon_delete_pattern_table		},
  {"MX920",		mx920_doc_icon_delete_pattern_table		},
  {ENDTAG, 		0}
};
