...
static const short borderless_media_value[] =
{
	CND_MEDIA_PROPHOTO,
...
int ShowMediaBorderDialog(UIMediaBorderDialog* dialog, short media_type)
{
	...
	gchar* dialog_msg
		= LookupText(g_keytext_list, "mediaborder_dialog_message");
	...
	gchar* alert_msg = LookupText(g_keytext_list, "mediaborder_alert");
