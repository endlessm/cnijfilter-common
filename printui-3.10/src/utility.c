...
void UtilNozzleCheck(LPUIDB uidb)
{
	...
	if( !strcmp(model_name, IDM_IP_2500) || !strcmp(model_name, IDM_IP_1800) ||
		...
		*p = 0x00;
		...
		!strcmp(model_name, IDM_MX_860)  ){	// 2008/11/26
...
void UtilRollerCleaning(LPUIDB uidb)
{
	...
	else if ( !strcmp(model_name, IDM_MP_540 ) || !strcmp(model_name, IDM_MP_630 ) || !strcmp(model_name, IDM_MX_860 ) ){ // 2008/11/28
...
void UtilSetConfig(LPUIDB uidb)
{
	...
	if (!strcmp(model_name, IDM_MP_160) ||
		...
		!strcmp(model_name, IDM_IP_1900) ||
		!strcmp(model_name, IDM_MX_860) || !strcmp(model_name, IDM_MX_320) || !strcmp(model_name, IDM_MX_330)  ){ // 2008/11/28
		SetDryLevel();
		return;
	}
	else {
