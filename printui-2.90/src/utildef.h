...
char *IP2600TestPatternTbl[2] = {		// 2007/11/26
...

{
  ...
  { IDM_IP_2600, IP2600TestPatternTbl },	// 2007/11/26
...
SETCONFIGINFO SetConfigInfo[] = 
{
	...
	{ IDM_IP_100,     CONFIG_TYPE_B  }, // 2007/11/26
	{ IDM_IP_2600,    CONFIG_TYPE_C  }, // 2007/11/26
};
...
PATTERNCHECKINFO PatternCheckInfo[] = 
{
	...
	{ IDM_MP_610,  { "okptn_mp610.xpm", 		// 2007/06/28
					 "ngptn_mp610.xpm" } },
	{ IDM_IP_100,  { "okptn_ip100.xpm", 		// 2007/11/26
					 "ngptn_ip100.xpm" } },
	{ IDM_IP_2600,  { "okptn_ip2600.xpm", 		// 2007/11/26
					 "ngptn_ip2600.xpm" } },
};
...
{ 
	...
	{ 3, 2, { "util_ink_cartridge_1", 		// type A // 2007/11/27
	   		"util_ink_cartridge_2", 
		    "util_ink_cartridge_3" },
 		  { "utility_message_55",
