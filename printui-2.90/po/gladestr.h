...
char *s = N_("Cancel");
char *s = N_("Canon Inkjet Printer Driver Ver.2.90 for Linux\n"
...
char *s = N_("Execute");
char *s = N_("Execute print head alignment. Examine the printed patterns, and \n"
             "enter the pattern number of the pattern with the least amount of \n"
             "streaking in the fields for columns A to N.");
